...
Before final response after a change:

- inspect changed files and summarize the diff
...
- mention residual risks, skipped checks, or assumptions
...
- apply project-specific rules in `docs/PROJECT_CONTEXT.md`
- record reusable harness improvements in `docs/HARNESS_NOTES.md`
- promote only repeated, reusable patterns to the shared templates
