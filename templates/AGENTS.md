...
- Never run destructive ops against the default branch (`git push --force`, `git push --force-with-lease`, `git reset --hard origin/main`, history rewrites) without explicit human approval in the current task.
